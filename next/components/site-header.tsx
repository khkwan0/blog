  ...
  return (
    <>
      <header className="relative z-10 overflow-visible border-b border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900">
        <div
          className={`relative mx-auto w-full ${maxWidthClass} px-6 pr-36 pt-4`}
        >
          <div className="flex justify-end pb-6">{children}</div>
          <Link
            href="/"
            aria-label="Home"
            className="absolute bottom-0 left-6 z-30 block h-0 w-32 hover:opacity-90"
          >
